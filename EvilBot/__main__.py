...
def get_readable_time(seconds: int) -> str:
    ...
    return ping_time
PM_START_TEXT = """
`𝙷𝚎𝚕𝚕𝚘` [👿](https://te.legra.ph/file/85aa9c86485bd0d711424.jpg) `мγ иαмє ιѕ` *ʜᴀʀᴜᴋɪ ✗ ʀᴏʙᴏᴛ*
`𝙸'𝚖 𝚑𝚎𝚛𝚎 𝚝𝚘 𝚑𝚎𝚕𝚙 𝚢𝚘𝚞 𝚖𝚊𝚗𝚊𝚐𝚎 𝚢𝚘𝚞𝚛 𝚐𝚛𝚘𝚞𝚙𝚜! 𝙷𝚒𝚝` *📚𝙲𝚘𝚖𝚖𝚊𝚗𝚍𝚜*   
"""
buttons = [
    [
        InlineKeyboardButton(
            text="𝐀𝐝𝐝 𝐌𝐞 𝐄𝐥𝐬𝐞 𝐘𝐨𝐮 𝐀𝐫𝐞 𝐆𝐞𝐲 🖤", url="t.me/Haruki_Robot?startgroup=true"),
    ],
     [
        InlineKeyboardButton(text="𝐀𝐛𝐨𝐮𝐭💝", callback_data="evil_"),
        InlineKeyboardButton(
            text="𝐌𝐲 𝐔𝐩𝐝𝐚𝐭𝐞𝐬 🔊", url=f"http://telegram.me/Haruki_Updates"
        ),
     ],
     [  
        InlineKeyboardButton(text="𝐒𝐮𝐩𝐩𝐨𝐫𝐭 🛠", url="https://telegram.me/CHAT_7STAR"),
        InlineKeyboardButton(text="𝐑𝐞𝐩𝐨 🇮🇳", url="https://github.com/priyanshuop123474/HarukiBot"),
    ], 
...
HELP_STRINGS = """
`𝙷𝚎𝚢!.. 𝙸'𝚖` 👿 *ʜᴀʀᴜᴋɪ ✗ ʀᴏʙᴏᴛ* [👿](https://te.legra.ph/file/85aa9c86485bd0d711424.jpg)
`𝙲𝚕𝚒𝚌𝚔 𝚘𝚗 𝚝𝚑𝚎 𝚋𝚞𝚝𝚝𝚘𝚗𝚜 𝚋𝚎𝚕𝚘𝚠 𝚝𝚘 𝚐𝚎𝚝 𝚍𝚘𝚌𝚞𝚖𝚎𝚗𝚝𝚊𝚝𝚒𝚘𝚗 𝚊𝚋𝚘𝚞𝚝 𝚜𝚙𝚎𝚌𝚒𝚏𝚒𝚌 𝚖𝚘𝚍𝚞𝚕𝚎𝚜..`"""
evil_IMG = "https://te.legra.ph/file/85aa9c86485bd0d711424.jpg"
DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project via [Paypal](#) or by contacting @Officialdhkd \
        ...
        query.message.edit_text(
            text=""" ℹ️ I'm powerful group management bot built to help you manage your group easily.
                 ...
                 \n\n_My licensed under the GNU General Public License v3.0_ 
                      here is this [Repository](https://github.com/priyanshuop123474/HarukiBot) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hey!.. I'm *ʜᴀʀᴜᴋɪ ✗ ʀᴏʙᴏᴛ*
                 \nHere is the [Source Code](https://github.com/priyanshuop123474/HarukiBot) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 5348334495 and DONATION_LINK:
            update.effective_message.reply_text(
